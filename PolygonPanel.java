...
g.fillRect(450, 200, 300, 100);
		...
		g.setColor(brown);
		int side1 [ ] = {200, 400, 500,300,100};
		int side2 [ ] = {600, 600, 500,200,500};
		g.fillPolygon(side1, side2, 5);
...
g.setColor(Color.red);
int hex1 [ ] = {800, 850, 900,950,900, 850};
int hex2 [ ] = {500, 400, 400,500,600, 600};
g.fillPolygon(hex1, hex2, 6);
...
int oct1 [ ] = {50, 50, 100,150,200,200,150,100};
int oct2 [ ] = {220, 170, 130,130,170, 220, 260,260};
g.fillPolygon(oct1, oct2, 8);
