...
public class WhileLoopDemos
{
	public static void main(String[] args) 
	{
		...
		{
			sum += cntr;
			//System.out.println("The value of cntr is: " + cntr);
			cntr--;
		}
		...
		while (k <= 10)
		{
			...
			if (z % 2 != 0)
			{
				System.out.println("The value of z being added is " + z);
				sum += z;
				k++; // only increment k if odd value is found
			}
			else
			{
				System.out.println(z + " is even so don't increment k.");
			}
		}
