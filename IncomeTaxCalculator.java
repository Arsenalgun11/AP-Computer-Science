...
{	
	...
	public static void main (String [] args)
	{
		...
		// Constant declarations for the main method.
		...
		// MAKE SURE YOU HAVE FIXED THE ABOVE BEFORE CONTINUING.
	...
	{
		double taxableIncome = grossIncome - STANDARD_DEDUCTION - DEPENDENT_DEDUCTION * numDependents;
	...
	{
		double IncomeTax = taxableIncome * TAX_RATE;
		return IncomeTax;
	}
