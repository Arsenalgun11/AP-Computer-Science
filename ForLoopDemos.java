...
public class ForLoopDemos
{
	public static void main(String[] args) 
	{
		...
		for (int number = 25; number <= 100; number += 5)
		{
		...
		System.out.print("Enter the upper limit to sum from: ");
		int upper = reader.nextInt();
		System.out.print("Enter the lower limit to sum down to: ");
		int lower = reader.nextInt();	
		sum = 0;	
		for(int cntr = upper; cntr >= lower; cntr--)
		{
			sum += cntr;
		}
		System.out.printf("The sum of the integers from %2d down to %2d is: %,15d%n", upper, lower, sum);
		...
		// Sum the first 10 random odd integers between 1 and 100
		sum = 0;
		for (int i = 1; i <= 10; i++)
		{
			...
			if (x % 2 != 0)
			{
				System.out.println("The value of x being added is " + x);
				sum += x;
			}
			else
			{
				i--;
				System.out.println(x + " is even so run loop extra time.");
			}
		}
...
*/	
		...
		System.out.println("The value of Integer.MAX_VALUE is " + Integer.MAX_VALUE + "\n");
		System.out.println();
		System.out.println("Printing random values in the range of 0 to 2,147,483,647 inclusive");
		System.out.println();
		for(int i = 1; i <= 100; i++)
		{
			int x = (int)(Math.random() * Integer.MAX_VALUE) + 1;
		...
		System.out.println();
		System.out.println("Printing random values in the range of -2,147,483,647 to -1 inclusive");
		System.out.println();
		System.out.println("The value of Integer.MIN_VALUE is " + Integer.MIN_VALUE + "\n");
		for(int i = 1; i <= 100; i++)
		{
			int x = ((int)(Math.random() * Integer.MAX_VALUE) + 1) - Integer.MIN_VALUE;
			System.out.printf("%,20d", x);
			if ( i % 5 == 0)
				System.out.println();
		}
		...
		System.out.println("Printing values using i++");
		System.out.println();
		for(int i = 1; i <= 10; i++)
		{
		...
		int i = 1;
		System.out.println("The value of i before the first method call is " + i);
		changeX(i++);
		System.out.println("The value of i after the first method call is " + i);	
		changeX(++i);
		System.out.println("The value of i after the second method call is " + i);
		
		System.out.println();	System.out.println();	System.out.println("Program has terminated.");

	} // end of main

	public static void changeX (int i)
	{
