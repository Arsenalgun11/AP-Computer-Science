...
public static void printLocationsOfTwoCharacters(String str, String twoLetters)
{
	...
	{
		String chara = str.substring(i, i+2);
		if (chara.compareTo(twoLetters) == 0)
		{
...
public static String buildReversedUpperCaseString(String str)
{
	 ...
	 */
			public static void printPositionOfVowelsInString(String str)
			{
				...
				{
					String volume1 = str.substring(i, i+1);
					if (volume1.compareTo("a") == 0 || volume1.compareTo("e") == 0 || volume1.compareTo("i") == 0 || volume1.compareTo("o") == 0 || volume1.compareTo("u") ==0)
							{
							System.out.println("A vowel in the string \"" + str + "\"is " + volume1 + "located at index " + i);
							}
				}
			}
