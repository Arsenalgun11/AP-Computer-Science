...
public class BirthdayMonth
{
	public static void main (String[] args)
	{
		...
		while (true)
		{
			...
			/*		
			if( expression1   logical op   expression2   logical op
				expression3   logical op   expression4   logical op
				expression5   logical op   expression6   logical op
				expression7   logical op   expression8   logical op
				expression9   logical op   expression10  logical op
				expression11  logical op   expression12 )
				{
					System.out.println("The word you entered is not a month"); 
			    }
			 */		
			if (month.compareTo("January") != 0 && month.compareTo("February") !=0 &&
				month.compareTo("March")!=0 && month.compareTo("April")!=0 &&
			...
			boolean spring = ((month.compareTo("March")==0 )|| (month.compareTo("April")==0) ||(month.compareTo("May")==0));
			...
			boolean summer = ((month.compareTo("June")==0) || (month.compareTo("July")==0) ||(month.compareTo("August")==0));
			...
			boolean fall = ((month.compareTo("September")==0) || (month.compareTo("October")==0) ||(month.compareTo("November")==0));
			...
			boolean winter = ((month.compareTo("December")==0) || (month.compareTo("January")==0) ||(month.compareTo("February")==0));
...
else if (spring != true && summer != true && winter != true && fall != true)
{
