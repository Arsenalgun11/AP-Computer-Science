...
public class IfElseOps
{
	...
	{		
		...
		double x = (int)(Math.random()*600)+400;
		...
		if(x<=500)
		{ 
			System.out.print("The random integer is smaller than or equal to 500");
		}
		...
		double y = Math.random() *75.0 + 50.0;
		...
		System.out.println("The random value stored in y is "+y);
		...
		// There are two possible ways to write your if condition.
		if (z<=20)
		{System.out.println("The random value is less than or equal to 20.0");
		}
		else
		{
		...
		// print out whether the random integer is even or odd using an if-else statement
		if (random%2 ==0)
		{
	...
	public static void processNumbers(int num1, int num2)
	{
		...
		System.out.println("The value of num2 is "+num2);
		{
			if (num1 >= num2)
			{
				System.out.println("No calculation, because num1 is greater than or equal to num2.");
			}
			else
			{
				num1 *= 50;
				System.out.println("50 times num1 is " + num1);
				num2 *= num2;
				System.out.println("The square of num2 is " + num2);
